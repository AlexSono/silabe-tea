...
var diccionario = [['afila','A-FI-LA'],['agua','A-GU-A','BEBIDAS'],['albondigas','AL-BON-DI-GAS'],['alex','A-LEX','FAMILIA'],['amarillo','A-MA-RI-LLO'],['andar','AN-DAR'],['apagar','A-PA-GAR'],['arena','A-RE-NA'],['avion','A-VIÓN','TRANSPORTES'],['azul','A-ZUL'],['bajar','BA-JAR'],['bañar','BA-ÑAR'],['barco','BAR-CO','TRANSPORTES'],['batido','BA-TI-DO','BEBIDAS'],['beber','BE-BER'],['bici','BI-CI','TRANSPORTES'],['blanco','BLAN-CO'],['bocadillo','BO-CA-DI-LLO'],['boli','BO-LI'],['bufanda','BU-FAN-DA'],['bus','B-U-S','TRANSPORTES'],['caballo','CA-BA-LLO'],['cafeteria','CA-FE-TE-RÍ-A','LUGARES'],['calle','CA-LLE','LUGARES'],['camion','CA-MIÓN',,'TRANSPORTES'],['camiseta','CA-MI-SE-TA'],['casa','CA-SA','LUGARES'],['chocolate','CHO-CO-LA-TE'],['coche','CO-CHE','TRANSPORTES'],['colegio','CO-LE-GIO','LUGARES'],['colornaranja','NA-RAN-JA'],['comer','CO-MER'],['croquetas','CRO-QUE-TAS'],['cubo','CU-BO','COSASDEPLAYA'],['dormir','DOR-MIR'],['elly','E-LLY'],['encender','EN-CEN-DER'],['escuchar','ES-CU-CHAR'],['espiner','ES-PI-NER','JUGUETES'],['filete','FI-LE-TE'],['fresa','FRE-SA','FRUTAS'],['fuente','FUEN-TE','LUGARES'],['furgoneta','FUR-GO-NE-TA','TRANSPORTES'],['galleta','GA-LLE-TA'],['gallina','GA-LLI-NA'],['gato','GA-TO'],['globo','GLO-BO','TRANSPORTES'],['goma','GO-MA'],['gorro','GO-RRO'],['gris','G-R-I-S'],['jugar','JU-GAR'],['kinder','KIN-DER'],['lapiz','LÁ-PIZ'],['lavar','LA-VAR'],['leche','LE-CHE','BEBIDAS'],['lula','LU-LA'],['macarrones','MA-CA-RRO-NES'],['mama','MA-MÁ','FAMILIA'],['manzana','MAN-ZA-NA','FRUTAS'],['mar','M-A-R'],['marron','MA-RRÓN'],['melocoton','ME-LO-CO-TÓN','FRUTAS'],['melon','ME-LÓN','FRUTAS'],['merendar','ME-REN-DAR'],['mirar','MI-RAR'],['morado','MO-RA-DO'],['moto','MO-TO','TRANSPORTES'],['naranja','NA-RAN-JA','FRUTAS'],['negro','NE-GRO'],['nina','NI-NA'],['ola','O-L-A'],['oveja','O-VE-JA'],['pala','PA-LA','COSASDEPLAYA'],['pan','P-A-N'],['pantalon','PAN-TA-LÓN'],['papa','PA-PÁ','FAMILIA'],['parque','PAR-QUE','LUGARES'],['patatas','PA-TA-TAS'],['patinete','PA-TI-NE-TE','JUGUETES'],['pato','PA-TO'],['pavo','PA-VO'],['peppapig','PE-PPA-PIG'],['pera','PE-RA','FRUTAS'],['perro','PE-RRO'],['pescado','PES-CA-DO'],['piña','PI-ÑA','FRUTAS'],['pingüino','PIN-GÜI-NO'],['platano','PLÁ-TA-NO','FRUTAS'],['playa','PLA-YA','LUGARES'],['pocoyo','PO-CO-YÓ'],['pollo','PO-LLO'],['puerta','PUER-TA','LUGARES'],['quiero','QUIE-RO'],['rastrillo','RAS-TRI-LLO','COSASDEPLAYA'],['roca','RO-CA'],['rojo','RO-JO'],['rosa','RO-SA'],['salchichas','SAL-CHI-CHAS'],['saltar','SAL-TAR'],['sopa','SO-PA'],['subir','SU-BIR'],['tablet','TA-BLET','JUGUETES'],['taxi','TA-XI','TRANSPORTES'],['trabajar','TRA-BA-JAR'],['tren','T-R-E-N','TRANSPORTES'],['verde','VER-DE'],['yogur','YO-GUR'],['zumo','ZU-MO','BEBIDAS']];
